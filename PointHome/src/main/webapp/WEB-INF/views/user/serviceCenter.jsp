...
<div id="mypageCon" class="container">
	...
	<div id="serviceDiv" style="margin: 200px auto; padding: 30px;">
		...
		<div id="serviceDiv2" style="background-color: white; padding: 30px; margin-bottom: 50px;">
			...
			<form action="./serviceCenter" method="post">
				<input class="form-control me-2"
					style="margin-right: 10px; width: 500px; display: inline-block;">
		...
		<div id="serviceDiv3"
			style="background-color: white; padding: 30px; margin-bottom: 50px;">
