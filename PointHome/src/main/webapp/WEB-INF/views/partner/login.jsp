...
<a class="title mt-3 mb-5" href="/">
   <div style="width:200px; heitght:200px;">
...
<ul class="nav nav-tabs nav-justified">
	...
	<li class="nav-item">
		<a class="selectLogin nav-link active text-dark" href="./login">제휴사</a>
	</li>
</ul>
...
<div class="nav justify-content-center col mt-2">
