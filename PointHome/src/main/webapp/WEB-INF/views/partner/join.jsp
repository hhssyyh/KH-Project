...
<link href="/resources/common/css/ani-background.css?d=<%= new Date() %>" rel="stylesheet">
...
<div class="form-content">
	...
	<div class="signup-text" href="/">회원가입</div>
	...
	<form action="/partner/join" method="post">
		...
		<div class="form-floating mb-3">
			<input type="text" class="form-control" name="partnerPw"
				id="partnerPw" placeholder="비밀번호"> <label for="partnerPw">비밀번호</label>
		</div>

		<div class="form-floating mb-3">
			<input type="text" class="form-control" name="partnerPwChk"
		...
		<div class="row g-2 mb-3">
			...
			<div class="form-floating col-3">
				...
				</select> <label for="partnerType">제휴타입</label>
			</div>
			...
			<div class="col-4">
				<div class="form-floating">
					<button type="button" class="btn btn-primary btn-lg"
						onclick="kakaoPostcode()">우편번호 찾기</button>
				</div>
			</div>
		</div>
