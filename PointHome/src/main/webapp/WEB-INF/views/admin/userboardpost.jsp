...
<div style="padding-right:300px; margin-left:110px; width: 100%;">
   ...
   <div id="filterDiv" style="text-align: right">
      ...
      <table id="listTable" class="table table-hover table-bordered text-center checkbox-table">
         ...
         <c:forEach var="board" items="${fblist}">
            <tr>
               ...
               <td class="text-start" style="font-weight: bold;"><a href="/freeboard/view?freeboardNo=${board.freeboardNo }">${board.freeboardTitle }</a></td>
